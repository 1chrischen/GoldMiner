...
public class Background {
	...
	//设置boolean变量，来控制商店功能
	static boolean bookStoneFlag =  false;
	static boolean DiamondFlag = false;
	
	//商店购买一次,状态确定
	static boolean Buying1 = true;
	static boolean Buying2 = true;
	
	//使用药水，鞭炮，保证只使用一次
	static boolean Usingwater = true;
	static boolean Usingfire = true;
	
	//游戏开始时间
	static long startTime; //静态变量
